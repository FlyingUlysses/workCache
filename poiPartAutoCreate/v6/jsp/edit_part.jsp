			                ...
			                <div class="widget blue">
			                      ...
			                      <div class="widget-body">
											 <div class="input-wrap">
											    	 <div class="tLable"><span style="width: 24%;">sheet类型：</span><span style="width: 25%; float: right;" id ="partName_title" >模板名称：</span></div>
											    	 <select id="sheetCat_select"  class="chzn-select" style="width: 26%;"   onchange="selectSheet();">
											    	 		<c:choose>
										            ...
										            <input type="text" id="partName_content" placeholder="请输入模板名称……" value="${part.name }" style=" width: 24%; float: right;" />
											</div>
											 <div class="input-wrap">
												         <c:choose>
												         	<c:when test="${part.isFixed ==1 }">
														    	 <div class="tLable"><span style="width: 24%;">sheet排序：</span><span style="width: 25%; float: right;" id ="sheetName_title" >sheet名称：</span></div>
														         <input type="number" id="part_sort" placeholder="请输入指定sheet排序……" value="${part.sort }" style=" width: 24%;"/>
												         		<input type="text" id="sheetName_content"  placeholder="请输入固定sheet名称……" value="${part.sheet }" style="width: 24%; float: right;" onblur="getAllSheet();"  />
												         	</c:when>
												         	<c:otherwise>
														    	 <div class="tLable"><span style="width: 24%;">sheet排序：</span><span style="width: 25%; float: right; display: none" id ="sheetName_title" >sheet名称：</span></div>
														         <input type="number" id="part_sort" placeholder="请输入指定sheet排序……" value="${part.sort }" style=" width: 24%;"/>
												         		 <input type="text" id="sheetName_content"  placeholder="请输入固定sheet名称……" value="${part.sheet }" style="width: 24%; float: right;display:none;"  onblur="getAllSheet();"  />
												         	</c:otherwise>
												         </c:choose>
											</div>
											<div  class="input-wrap">
								...
								<div class="widget-title" id ="role_title" >
					               	 <h4><i class="icon-align-left">Excel表头编辑</i></h4>
					               	  <div class="update-btn">
					               	  	<button  type="button" style="margin-bottom: 10px;" class="btn btn-warning" onclick="saveCellToSql();"></i>&nbsp;<span style="font-size: 12px;" ">保存至sql</span></button>
					               	  	...
					               	  	<button  type="button" style="margin-bottom: 10px;" class="btn btn-warning" onclick="rmvRow();"></i>&nbsp;<span style="font-size: 12px;">删除</span></button>
					               	  </div>
					            </div>
								<div class="widget-body">
