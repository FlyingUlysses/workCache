...
<script src="<%=basePath %>/resources/scripts/poi/poi_v2.js"></script>
<style>
<!--
			...
			<div class="widget-title" id ="role_title" >
               	 <h4><i class="icon-align-left">Excel导出功能列表</i></h4>
               	  <div class="update-btn">
               	  	...
               	  	<button id="toTest" type="button" style="margin-bottom: 10px;" class="btn btn-warning"><i class="icon-plus"></i>&nbsp;<span style="font-size: 12px;">跳转测试</span></button>
               	  </div>
            </div>
